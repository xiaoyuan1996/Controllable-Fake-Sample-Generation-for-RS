...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/new_leader.json',
            ...
            for _, train_data in enumerate(train_loader):
                ...
                if current_step % opt['train']['val_freq'] == 0:
                    ...
                    for _,  val_data in enumerate(val_loader):
                        ...
                        sr_leader_img = Metrics.tensor2img(visuals['lead_SR'])  # uint8
                        ...
                        Metrics.save_img(
                            sr_leader_img, '{}/{}_{}_sr_leader.png'.format(result_path, current_step, idx))
                        Metrics.save_img(
