...
class UNet(nn.Module):
    def __init__(
        ...
        # self.ups_copy = copy.deepcopy(self.ups)
        # self.final_conv_copy = copy.deepcopy(self.final_conv)
    ...
    #             x = layer(x)
    #
    #     for layer in self.ups_copy:
    #         if isinstance(layer, ResnetBlocWithAttn):
    #             x = layer(torch.cat((x, feats.pop()), dim=1), t)
    #         else:
    #             x = layer(x)
    #
    #     return self.final_conv_copy(x)
