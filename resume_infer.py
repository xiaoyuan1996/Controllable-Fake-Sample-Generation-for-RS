...
if __name__ == "__main__":
    ...
    Logger.setup_logger('val', val_path, 'infer_compare', level=logging.INFO)
    ...
    logger_val.info('resume: {} <steps:{:4d}, eta:{:.2e}> FID: {:.4e} IS: {:.4e} brisque:{:.4e}'.format(
        opt['path']['resume_state'],steps, eta, Fid, IS, brisque))
