...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/leader_network.json',
    ...
    #     opt['path'][
    #         'resume_state'] = "/data/diffusion_data/experiments/discri_trian_220928_031050/checkpoint/" + args.resume
