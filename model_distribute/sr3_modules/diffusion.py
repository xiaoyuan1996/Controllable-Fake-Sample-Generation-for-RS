...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        self.denoise_fn_1 = denoise_fn1
        self.denoise_fn_2 = denoise_fn2
        self.denoise_fn_3 = denoise_fn3
    ...
    def set_denoise_fn(self,t):
        if t >= 0 and  t < self.num_timesteps//3:
            self.denoise_fn = self.denoise_fn_1
        elif t >= self.num_timesteps//3 and t < self.num_timesteps*2 // 3:
            self.denoise_fn = self.denoise_fn_2
        else:
            self.denoise_fn = self.denoise_fn_3
